                        ...
                        <div class="s-report-inner pr--20 pt--30 mb-3">
                            ...
                            <div class="s-report-title d-flex justify-content-between">
                                ...
                                @elseif(Auth::user()->type == 'department head')
                                    <h4 class="header-title mb-0">Pending {{Auth::user()->head_department}} Reports</h4>
                                @else
                                    <h4 class="header-title mb-0">Pending {{Auth::user()->head_cluster_area}} Reports</h4>
                                @endif
                                {{--<p>24 H</p>--}}
                            </div>
                            <div class="d-flex justify-content-between pb-2">
                                <h2 class="ml-5">{{$reports}}</h2>
                                {{--<span>- 45.87</span>--}}
                            </div>
                        </div>
                    ...
                    <div class="single-report mb-xs-30 shadow">
                        <div class="s-report-inner pr--20 pt--30 mb-3">
                            ...
                            <div class="s-report-title d-flex justify-content-between">
                                ...
                                @elseif(Auth::user()->type == 'department head')
                                    <h4 class="header-title mb-0">{{Auth::user()->head_department}} Care Groups</h4>
                                @else
                                    <h4 class="header-title mb-0">{{Auth::user()->head_cluster_area}} Care Groups</h4>
                                @endif
                                {{--<p>24 H</p>--}}
                            </div>
                            <div class="d-flex justify-content-between pb-2">
                                <h2 class="ml-5">{{$groups}}</h2>
                                {{--<span>- 45.87</span>--}}
                            </div>
                        </div>
                    ...
                    <div class="single-report shadow">
                        <div class="s-report-inner pr--20 pt--30 mb-3">
                            ...
                            <div class="s-report-title d-flex justify-content-between">
                                ...
                                @elseif(Auth::user()->type == 'department head')
                                    <h4 class="header-title mb-0">{{Auth::user()->head_department}}</h4>
                                @else
                                    <h4 class="header-title mb-0">{{Auth::user()->head_cluster_area}} Users</h4>
                                @endif
                                {{--<p>24 H</p>--}}
                            </div>
                            <div class="d-flex justify-content-between pb-2">
